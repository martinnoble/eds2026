var CustomImportScript = (() => {
  ...
  // tools/importer/import-jewellery.js
  var import_jewellery_exports = {};
  __export(import_jewellery_exports, {
    default: () => import_jewellery_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "jewellery",
    description: "Portfolio gallery page with centered heading, intro paragraph, and card grid showing handmade jewellery with images, titles, and descriptions",
    urls: [
      "https://www.martinnoble.com/jewellery"
    ],
    blocks: [
      {
        name: "cards-gallery",
  ...
  return __toCommonJS(import_jewellery_exports);
})();
